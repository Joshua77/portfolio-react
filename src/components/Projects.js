...
import projImg2 from "../assets/img/projectImg2.jpg";
          ...
          <Col size={12}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                <h2>Projects</h2>
                <p>Have a sneek peak of the well designed, fast, SEO friendly web application solutions I have deployed for clients, businesses and brands.</p>
